...
- **Android SDK:** Version **1.8.1** (required)
- **iOS SDK:** Version **1.3.3** (required)

## Android Setup

**Important:** The Paymob Android SDK is not included in this plugin. You must download and configure **version 1.8.1** in your app.

1. **Download Paymob Android SDK 1.8.1** from [here](https://paymob-my.sharepoint.com/:f:/p/ahmedsobhy/EjQrdOdzUzhIqlQmcsE9Hg0BOVjJYOu2BMGRClGVEa9dJA?e=hfFnnI). Look for `PaymobAndroidSDK1.8.1` in the package.

2. **Add SDK to your app:**
   - Create `android/libs/` directory
   - Place the AAR file there: `android/libs/com/paymob/sdk/Paymob-SDK/1.8.1/Paymob-SDK-1.8.1.aar`
...
**Important:** The Paymob iOS SDK is not included in this plugin. You must download and configure **version 1.3.3** in your project.

1. **Download Paymob iOS SDK 1.3.3** from [here](https://paymob-my.sharepoint.com/:f:/p/mahmoudyoussef/El9q1ULaxcBFkQurwvXkZQEBY9S-6dwhWL9xXQgjEnGPBQ?e=0sKgCf). Look for `PaymobSDK 1.3.3` (xcframework) in the package.
